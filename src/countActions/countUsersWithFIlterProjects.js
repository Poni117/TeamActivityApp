...
export default function CountUsersWithFIlterProjects(users, projects, workspaces, spaces, dates, filterLocation){
    ...
    usersClone.forEach(async user => {
        ...
        projects.forEach(async project => {
            ...
            if (filterLocation.issue !== project.name) {
                return;
            }
        ...
        workspaces.map(async workspace => {
            ...
            workspace.repositories.map(async repository => {
                ...
                if (filterLocation.codes !== repository.repository) {
                    return;
                }
        ...
        spaces.forEach(space => {
            ...
            if (filterLocation.docs !== space.space) {
                return;
            }
